...
public func LoadLevel1() {
    ...
    scene.place(startLabel, at: Point(x: -170, y: 150))
    
    let endLabel = Label(text: "End", color: corText, size: 15)
    endLabel.isHidden = true
    scene.place(endLabel, at: Point(x: 170, y: -50))
    
    let sumLabel = Label(text: "\(String(sum)) / 10", color: corText)
    ...
    scene.place(boxText2, at: Point(x: -50, y: -260))
